...
KEYS_CALENDAR = {
        ...
        "   v   ": "Переключать дневной вид",
        "   w   ": "Переключать еженедельный вид",
        "   W   ": "Переключать номера недель",
...
MSG_KEYS_INFO     = "Для настройки клавиш, смотрите:"
...
MSG_EVENT_FR      = "Повторить событие каждый день (d), неделю (w), раз в две недели (b), месяц (m) или год(y)? "
...
MSG_TS_DONE_COUNT = "Выполнено задач"
...
CALENDAR_HINT_W   = "Пробел · Переключить на журнал   a · Новое событие  n/p · Сменить неделю   ? · Клавиши"
